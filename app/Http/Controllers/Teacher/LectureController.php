...
class LectureController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('teacher.lectures.index', compact('sections'));
    ...
    public function data()
    {
        ...
        return DataTables::of($lectures)
            ...
            ->addColumn('actions', function (Lecture $lecture) {
                return view('teacher.lectures.data_table.actions', compact('lecture'));
            })
    ...
    public function create()
    {
        ...
        return view('teacher.lectures.create', compact('sections'));
    ...
    public function store(LectureRequest $request)
    {
        ...
        return response()->json([
            'redirect_to' => route('teacher.lectures.index'),
        ]);
    ...
    public function edit(Lecture $lecture)
    {
        ...
        return view('teacher.lectures.edit', compact('sections', 'lecture'));
