                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('teacher.lectures.index') }}" wire:navigate>@lang('lectures.lectures')</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('teacher.lectures.store') }}" class="ajax-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="date" class="form-control date-picker" dir="{{ in_array(app()->getLocale(), ['ar']) ? 'rtl' : 'ltr' }}" value="{{ old('date') }}" required>
                                </div>
