                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a
                                            href="{{ route('teacher.student_exams.index') }}">@lang('student_exams.student_exams')</a>
                                </li>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th style="display: flex">
                                                ...
                                                <a href="{{ route('teacher.students.show', $studentExam->student_id) }}">@lang('site.show')</a>
                                            </th>
                                        </tr>
