        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <a href="{{ route('teacher.student_exams.show', $studentExam) }}" class="btn btn-secondary">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('teacher.student_exams.update_grade', $studentExam) }}" method="POST" id="gradingForm">
                    @csrf
                    @method('PUT')
