                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('teacher.books.index') }}">@lang('books.books')</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('teacher.books.update', $book->id) }}" class="ajax-form">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="project_id" class="form-control select2" required>
                                        ...
                                        @foreach ($projects as $project)
                                            <option value="{{ $project->id }}" {{ $project->id == $book->project_id ? 'selected' : '' }}>{{ $project->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
