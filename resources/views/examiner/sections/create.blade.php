                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('teacher.sections.index') }}" wire:navigate>@lang('sections.sections')</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('teacher.sections.store') }}" class="ajax-form">
                                @csrf
                                @method('post')
