                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">@lang('services.services')</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (auth()->user()->hasPermission('create_services'))
                                        <a href="{{ route('admin.services.create') }}" wire:navigate class="btn btn-primary"><i data-feather="plus"></i> @lang('site.create')</a>
                                    @endif
