<nav class="header-navbar navbar navbar-expand-lg align-items-center navbar-light navbar-shadow fixed-top">
    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
            ...
            {{--sections--}}
            <li class="nav-item dropdown dropdown-section">

                <a class="nav-link dropdown-toggle" id="dropdown-flag" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">

                    {{ session('selected_center')['name'] }}

                </a>

                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-flag">

                    @foreach (auth()->user()->teacherAndManagerCenters as $center)

                        <a class="dropdown-item" href="{{ route('teacher.switch_center', ['center_id' => $center->id]) }}">
                            {{ $center->name }}
                        </a>
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex d-none">
                        ...
                        <span class="user-status">{{ auth()->user()->hasRole('center_manager') ? __('roles.center_manager') : __('roles.teacher') }} </span>
                    </div>
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdown-user">
                    ...
                    @if(session('impersonated_by'))
                        ...
                        <a class="dropdown-item" href="{{ route('teacher.leave_impersonate') }}">
                            <i class="mr-50" data-feather="power"></i>
                            @lang('teachers.return_to_original_admin')
                        </a>
